	...
	public static void main(String[] args) {
		...
		while (rodar != 1) {
			while (!valido) {
				...
				if (entradaCompleta.length() > 11 || entradaCompleta.length() < 3) {
					Impressoes.entradaInvalida();
				} else {
					valido = true;
				}
			}
			...
			cmd = null;
			carregadorArgs.setArg1(null);
			carregadorArgs.setArg2(null);
			valido = false;
		}
